...
def sinApprox(x: sp.Expr) -> sp.Expr:
    """
    ...
    return sp.Piecewise(
        (0.00773818879926878*x**5 + 0.000663917492157654*x**4 - 0.166960828483897*x**3 + 5.7434780036691e-5*x**2 + 0.999995926533202*x + 1.7994603566393e-8, (x <= 0.698131700797732)),
...
def cosApprox(x: sp.Expr) -> sp.Expr:
    """
    ...
    # The absolute approximation error is < 1e-6 on [0,2*pi].
    return sp.Piecewise(
        (-0.00288739530618162*x**5 + 0.0439252265142042*x**4 - 0.000799918150962147*x**3 - 0.499878335228715*x**2 - 6.01354184082809e-6*x + 1.00000003934287, (x <= 0.698131700797732)),
        (-0.00717785141296623*x**5 + 0.0582850051959961*x**4 - 0.0210938260006542*x**3 - 0.484796584038749*x**2 - 0.00584769968671546*x + 1.00093325460221, (x >= 0.698131700797732) & (x <= 1.39626340159546)),
        (-0.0081663401185344*x**5 + 0.0640755089478419*x**4 - 0.0344382557987987*x**3 - 0.469801170795325*x**2 - 0.0139423830114034*x + 1.00256340366631, (x >= 1.39626340159546) & (x <= 2.0943951023932)),
        (-0.00533733357584177*x**5 + 0.0334905665841516*x**4 + 0.0984652267242132*x**3 - 0.759861452081371*x**2 + 0.303898641117232*x + 0.862723470758349, (x >= 2.0943951023932) & (x <= 2.79252680319093)),
        (-0.0414013572836275*x**4 + 0.520260138376733*x**3 - 1.95165832752488*x**2 + 1.99315384809751*x - 0.0980430350344578, (x >= 2.79252680319093) & (x <= 3.49065850398866)),
        (0.00540756624959866*x**5 - 0.135536004872834*x**4 + 1.17727653122035*x**3 - 4.24987511142429*x**2 + 6.02206165743307*x - 2.92971708446136, (x >= 3.49065850398866) & (x <= 4.18879020478639)),
        (0.00814621680076753*x**5 - 0.192021783190193*x**4 + 1.64386022808618*x**3 - 6.17931096934447*x**2 + 10.0164697920878*x - 6.24175465825977, (x >= 4.18879020478639) & (x <= 4.88692190558412)),
        (0.00720389874853809*x**5 - 0.167895146617105*x**4 + 1.39705776323073*x**3 - 4.91830341105373*x**2 + 6.79801658356085*x - 2.95877279706852, (x >= 4.88692190558412) & (x <= 5.58505360638185)),
        (0.00283205116741017*x**5 - 0.0451158705740756*x**4 + 0.0166178033351698*x**3 + 2.84859737418428*x**2 - 15.0700539456296*x + 21.6896813309481, True)
    )    